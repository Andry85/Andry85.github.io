	...
	<div class="row lg-pb-30">
		<div class="col-md-12">
			...
			<section class="asProductDesc">
				<h1 class="asProductDesc__title">Офисные перегородки В КИЕВЕ</h1>
				<ul class="breadcrumb">
					<li class="breadcrumb__item">
						<a class="breadcrumb__link" href="index.php"><i class="icons fa fa-home"></i></a>
					</li>
					<li class="breadcrumb__item">
						<span>купить офисные перегородки киев</span>
					</li>
				</ul>
			...
			<?php include 'contents/regional/your_city-peregorodki/whereToBuy/whereToBuy.php'; ?>
...
<?php include 'contents/regional/your_city-peregorodki/navi.php'; ?>
