<div class="getCallWrap">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="getCallWrap__title">поможем подобрать<br> защитные роллеты на окна и двери</h2>
				<p class="getCallWrap__text">Получите бесплатную консультацию по выбору защитных роллет на окна и двери. Мы предложим оптимальный вариант исходя из ваших предпочтений</p>
