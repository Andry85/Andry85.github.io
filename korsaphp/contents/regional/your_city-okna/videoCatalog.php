<div class="videoCatalog">
	<div class="row">
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профільна система REHAU EURO 70</h2>
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео:Профільна система REHAU ECOSOL 60</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Ламінація та фарбування металопластикових вікон</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Як правильно обрати металопластикове вікно?</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профільна система REHAU BRILLANT DESIGN</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профільна система REHAU GENEO</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профільна система REHAU GENEO PHZ</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Алюмінєві теплі вікна</h2>
				<div class="videoBlock__source">
