<div class="videoCatalog hidden-xs">
	<div class="row">
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">ВИДЕО: Профильная система REHAU EURO 70</h2>
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">ВИДЕО: Профильная система REHAU ECOSOL 60</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Ламинация и окраска металлопластиковых окон</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Как правильно выбрать металлопластиковое окно?</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профильная система REHAU BRILLANT DESIGN</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профильная система REHAU GENEO</h2>
				<div class="videoBlock__source">
	...
	<div class="row">	
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Профильная система REHAU GENEO PHZ</h2>
				<div class="videoBlock__source">
		...
		<div class="col-md-6">
			<article class="videoBlock">
				<h2 class="as__subtitle">Видео: Алюминиевые теплые окна</h2>
				<div class="videoBlock__source">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/TzXcQLM9bA4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</article>
		</div>
	</div>
