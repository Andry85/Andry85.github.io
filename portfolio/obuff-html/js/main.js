	...
	/********************************************************/
		...
		if(device.desktop()) {	
			...
			$('.bx-wrapper img').mousemove(function(e){ 
				...
				var parrent_with = $(this).parents(".bx-wrapper").width();
				var imgHeight = $(this).height();
				var imgWith = $(this).width();
				var zapasWith = imgWith - parrent_with;
				var zapasHeight = imgHeight - parrent_height;
				var coefWith = zapasWith/parrent_with;
				var coefHeight = zapasHeight/parrent_height;
				var  x = (e.pageX - offset.left) * coefWith;
				var  y = (e.pageY - offset.top) * coefHeight;
				$(this).animate({left: -x,top: -y},10);
			});
